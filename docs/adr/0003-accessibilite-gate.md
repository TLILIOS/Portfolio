...
- Les fichiers de sous-titres VTT manquants sont des TODO (le `<track>` est référencé en placeholder) — ne bloquent pas si la vidéo n'est pas servie comme contenu informatif autonome.
